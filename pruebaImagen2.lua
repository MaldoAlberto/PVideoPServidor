...
model=torch.load('modelo2/modelo2_float.bin')
...
mean_y=torch.load('modelo2/mean_y_modelo2')
mean_u=torch.load('modelo2/mean_u_modelo2')
mean_v=torch.load('modelo2/mean_v_modelo2')

std_y=torch.load('modelo2/std_y_modelo2')
std_u=torch.load('modelo2/std_u_modelo2')
std_v=torch.load('modelo2/std_v_modelo2')
