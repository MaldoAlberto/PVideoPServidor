...
model=torch.load('modelo3/modelo3_float.bin')
...
mean_y=torch.load('modelo3/mean_y_modelo3')
mean_u=torch.load('modelo3/mean_u_modelo3')
mean_v=torch.load('modelo3/mean_v_modelo3')

std_y=torch.load('modelo3/std_y_modelo3')
std_u=torch.load('modelo3/std_u_modelo3')
std_v=torch.load('modelo3/std_v_modelo3')
