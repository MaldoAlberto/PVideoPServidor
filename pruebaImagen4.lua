...
model=torch.load('modelo4/modelo4_float.bin')
...
mean_y=torch.load('modelo4/mean_y_modelo4')
mean_u=torch.load('modelo4/mean_u_modelo4')
mean_v=torch.load('modelo4/mean_v_modelo4')

std_y=torch.load('modelo4/std_y_modelo4')
std_u=torch.load('modelo4/std_u_modelo4')
std_v=torch.load('modelo4/std_v_modelo4')
