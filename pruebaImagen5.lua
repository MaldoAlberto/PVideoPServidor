...
model=torch.load('modelo5/modelo5_float.bin')
...
mean_y=torch.load('modelo5/mean_y_modelo5')
mean_u=torch.load('modelo5/mean_u_modelo5')
mean_v=torch.load('modelo5/mean_v_modelo5')

std_y=torch.load('modelo5/std_y_modelo5')
std_u=torch.load('modelo5/std_u_modelo5')
std_v=torch.load('modelo5/std_v_modelo5')
